...
class AmberCLIBase(BaseModel, YamlIO, Render):
    ...
    **Sander option:** `-i`
    ...
    [configs.workflow.amber.inputs.AmberInputsBase] should be in this file.
    ...
    **File paths.**
    ...
    [`ntpr`][configs.workflow.amber.inputs.AmberInputsBase.ntpr] steps.
    ...
    **Sander option:** `-inf`
    ...
    [`mdout`][configs.workflow.amber.cli.AmberCLIBase.mdout] and other
