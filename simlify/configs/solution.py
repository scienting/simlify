...
class SolutionConfig(BaseModel, YamlIO):
    ...
    [configs.SolutionConfig.charge_anion_identity] to add to
    the system. This does not include any ions added if [`charge_neutralize`]
    [configs.SolutionConfig.charge_neutralize] is `True`.
    """
    ...
    [configs.SolutionConfig.charge_cation_identity] to add to the
    ...
    [configs.SolutionConfig.charge_cation_identity]
    or [`charge_anion_identity`]
    [configs.SolutionConfig.charge_anion_identity] based on
    the value of [`charge_net`]
    [configs.SolutionConfig.charge_net].
    """
